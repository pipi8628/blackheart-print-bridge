...
public class MainActivity extends Activity {
    ...
    private void buildUi() {
        ...
        TextView title = tv("🏷️ 黑心地瓜球 列印橋 APK", 28, Color.WHITE, true);
        root.addView(title);
    ...
    private void testPrint() {
        ...
        new Thread(() -> {
            try {
                String tspl = "SIZE 40 mm,30 mm\\r\\n" +
                        "GAP 2 mm,0\\r\\n" +
                        "DIRECTION 1\\r\\n" +
                        "CLS\\r\\n" +
                        "TEXT 20,20,\\\"0\\\",0,2,2,\\\"TEST\\\"\\r\\n" +
                        "TEXT 20,85,\\\"0\\\",0,1,1,\\\"ANDROID APK\\\"\\r\\n" +
                        "TEXT 20,125,\\\"0\\\",0,1,1,\\\"HEIXIN POS\\\"\\r\\n" +
                        "PRINT 1\\r\\n";
                sendSocket(tspl);
                ui(() -> status("測試列印已送出"));
            } catch (Exception ex) {
